...
export default function Career() {
  return (
    <Layout>
      <Banner title="Career " bg_img="https://i.ibb.co/g6chxB5/career.jpg" />
      <h1 className="  text-4xl text-center my-10">Join Our Awesome Team </h1>
      <div className="max-w-screen-xl  mx-auto p-4 flex flex-col md:flex-row justify-center gap-10 items-center ">
        {/* card 1 */}
        <div className="bg-white/70 p-10 text-center space-y-5 rounded-lg max-w-sm border-2 shadow-md">
